  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-24 bg-gray-100 px-4">
      <div className="bg-white shadow-xl rounded-lg w-full max-w-md overflow-hidden">
        ...
        <button className="flex items-center justify-center gap-2 border px-4 py-2 rounded-md w-full">
  ...
  Continue with Google
        ...
        <form className="space-y-4">
          <div>
            ...
            <input type="email" className="w-full border border-gray-300 rounded-md px-3 py-2 mt-1" placeholder="Enter your email" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700">Password</label>
            <input type="password" className="w-full border border-gray-300 rounded-md px-3 py-2 mt-1" placeholder="Enter your password" />
          </div>
